...
export default function ActionSports() {
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="iframe-wrapper" style={{ display: isLoading ? 'none' : 'block' }}>
          <iframe
            id="streaming-iframe"
            src="https://crichdplay.info/channel/sky-sports-action-live-streaming-free/"
            allowFullScreen
            className="iframe"
